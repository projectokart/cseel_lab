...
const navItems = [
  { label: "Dashboard",    icon: LayoutDashboard, to: "/org" },
  { label: "Teachers",     icon: GraduationCap,   to: "/org/teachers" },
  { label: "Students",     icon: Users,           to: "/org/students" },
  { label: "Classes",      icon: BookOpen,        to: "/org/classes" },
  { label: "Reports",      icon: BarChart3,       to: "/org/reports" },
  { label: "Settings",     icon: Settings,        to: "/org/settings" },
];
